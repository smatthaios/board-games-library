...
import gr.boardgames.library.enumeration.SessionAttribute;
import gr.boardgames.library.enumeration.SupportedLanguage;
import gr.boardgames.library.exception.*;
import gr.boardgames.library.exception.SecurityException;
import gr.boardgames.library.service.UserService;
...
public abstract class AbstractController {
	...
	protected Response handleException(BoardException exception, HttpServletRequest request) {
	...
	/**
	 * Retrieves the logged in {@link gr.boardgames.library.domain.User} from the {@link javax.servlet.http.HttpSession}.
	 *
	 * @param request the {@link javax.servlet.http.HttpServletRequest}
	 * @return the logged in {@link gr.boardgames.library.domain.User}
	 */
