...
import gr.boardgames.library.enumeration.UserRole;
import gr.boardgames.library.enumeration.UserStatus;
...
public class User extends LoggableEntity {
	...
	/**
	 * Creates the string representation of the {@link gr.boardgames.library.domain.User}.
	 *
	 * @return String representing the {@link gr.boardgames.library.domain.User}
	 */
	@Override
