...
/** The {@link gr.boardgames.library.exception.DataCalculationException} must be thrown when an error occurs during any calculation. */
public class DataCalculationException extends DataException {
	...
	/**
	 * Instantiates a new {@link gr.boardgames.library.exception.DataCalculationException}.
	 *
