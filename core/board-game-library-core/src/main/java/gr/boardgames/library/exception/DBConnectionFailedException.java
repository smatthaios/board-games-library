...
/** The {@link gr.boardgames.library.exception.DBConnectionFailedException} must be thrown when database connection fails. */
public class DBConnectionFailedException extends DataException {
	/**
	 * Instantiates a new {@link gr.boardgames.library.exception.DBConnectionFailedException}.
	 *
