...
/** The {@link gr.boardgames.library.exception.DataNotFoundException} must be thrown when the application cannot retrieve data that should exist in the DB. */
public class DataNotFoundException extends DataException {
	...
	/**
	 * Instantiates a new {@link gr.boardgames.library.exception.DataNotFoundException}.
	 *
