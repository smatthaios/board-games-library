...
/** The {@link gr.boardgames.library.exception.InsufficientAccessRightException} must be thrown when someone is trying to perform unauthorised actions. */
public class InsufficientAccessRightException extends SecurityException {
	/**
	 * Instantiates a new {@link gr.boardgames.library.exception.InsufficientAccessRightException}.
	 *
