...
/** The {@link UserNotUniqueException} must be thrown when a {@link gr.boardgames.library.domain.User} is not unique in the user repository. */
public class UserNotUniqueException extends DataException {
	...
	/**
	 * Gets the {@link gr.boardgames.library.enumeration.FaultReason} object representing the cause of the application error.
	 *
	 * @return the {@link gr.boardgames.library.enumeration.FaultReason} object representing the cause of the application error
	 */
