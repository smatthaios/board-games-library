...
/** The {@link gr.boardgames.library.exception.IOException} is thrown when I/O errors occur during the different operations. */
public class IOException extends BoardException {
	/** The serial version unique identifier. */
	private static final long serialVersionUID = 8876408990295495762L;

	/**
	 * Instantiates a new {@link gr.boardgames.library.exception.IOException}.
	 *
	 ...
	 *
	 * @param message     the message that contains information about the raised exception
	 * @param faultReason a {@link gr.boardgames.library.enumeration.FaultReason} object representing the causes of the application error
	 */
